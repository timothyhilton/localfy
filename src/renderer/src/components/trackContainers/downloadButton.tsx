...
export default function DownloadButton(props:{ onClick: () => void, lighter: boolean | undefined}){
    return(
        <div className="ml-auto mr-1 mt-1 " onClick={props.onClick}>
            <Button variant="outline" size="icon" className={`dark:bg-slate-950 dark:border-slate-800 bg-slate-50 ${props.lighter ? "bg-white" : ""}`}>
