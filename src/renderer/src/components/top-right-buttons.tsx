...
export function SignOut(){
  return (
    <Button variant="outline" size="icon" className="align-top" onClick={() => {
        window.api.setSetting({setting: 'token', value: null})
        window.api.setSetting({setting: 'refresh_token', value: null})
